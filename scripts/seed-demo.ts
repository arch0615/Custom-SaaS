...
const PROCESSES: ProcessSeed[] = [
  ...
  // Coverage for the remaining 8 stages so every column of the kanban has data.
  { customerIdx: 1, modal: "maritime", stage: "aguarda_booking", origin: "SSZ — Santos", destination: "HAM — Hamburgo", shipmentDays: 14, arrivalDays: 42, carrier: "Hapag-Lloyd", incoterm: "FOB", invoiceUSD: 78000, ncm: "1701.14.00" },
  { customerIdx: 7, modal: "maritime", stage: "aguarda_draft", origin: "ANR — Antuérpia", destination: "ITJ — Itajaí", shipmentDays: 10, arrivalDays: 36, hbl: "HBL-2026-0184", carrier: "CMA CGM", incoterm: "CIF", invoiceUSD: 105000, ncm: "2906.11.00" },
  { customerIdx: 4, modal: "maritime", stage: "aguarda_aprovacao_draft", origin: "SHA — Shanghai", destination: "SSZ — Santos", shipmentDays: 8, arrivalDays: 40, hbl: "HBL-2026-0189", mbl: "MAEU112244", carrier: "Maersk", incoterm: "FOB", invoiceUSD: 81000, ncm: "8504.40.90" },
  { customerIdx: 0, modal: "maritime", stage: "aguarda_draft_atualizado", origin: "HKG — Hong Kong", destination: "SSZ — Santos", shipmentDays: 5, arrivalDays: 32, hbl: "HBL-2026-0193", mbl: "MAEU224488", carrier: "MSC", incoterm: "CIF", invoiceUSD: 142000, ncm: "8528.72.00" },
  { customerIdx: 6, modal: "maritime", stage: "aguarda_hbl_final", origin: "ROT — Rotterdam", destination: "RIO — Rio de Janeiro", shipmentDays: 1, arrivalDays: 26, mbl: "ONEU558877", carrier: "OOCL", vessel: "OOCL Atlanta", incoterm: "CIF", invoiceUSD: 195000, ncm: "8474.20.00" },
  { customerIdx: 5, modal: "maritime", stage: "aguarda_transbordo", origin: "SSZ — Santos", destination: "SIN — Singapura", shipmentDays: -15, arrivalDays: 19, containerNumber: "MSCU7766554", hbl: "HBL-2026-0166", mbl: "MAEU667733", carrier: "MSC", vessel: "MSC Gülsün", incoterm: "FOB", invoiceUSD: 412000, ncm: "1005.90.10" },
  { customerIdx: 2, modal: "maritime", stage: "aguarda_desconsolidacao", origin: "SHA — Shanghai", destination: "SSZ — Santos", shipmentDays: -28, arrivalDays: -5, containerNumber: "TCLU8899001", hbl: "HBL-2026-0145", mbl: "MAEU441199", carrier: "Maersk", vessel: "Maersk Hangzhou", incoterm: "CIF", invoiceUSD: 96000, ncm: "8471.30.12" },
  { customerIdx: 3, modal: "maritime", stage: "aguarda_pagamento", origin: "BCN — Barcelona", destination: "ITJ — Itajaí", shipmentDays: -50, arrivalDays: -10, containerNumber: "OOLU3344112", hbl: "HBL-2026-0111", mbl: "ONEU663322", carrier: "OOCL", vessel: "OOCL Brisbane", incoterm: "CIF", invoiceUSD: 178000, ncm: "7208.10.00" },
];
